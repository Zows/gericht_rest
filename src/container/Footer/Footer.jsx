  ...
  <div className="app__footer section__padding">
    ...
    <div className="app__footer-links">
      ...
      <div className="app__footer-links_logo">
        ...
        <p className="p__opensans">"The b  est way to find yourself is to lose yourself in the service of others.”</p>
        <img src={images.spoon} className="spoon__img" alt="spoon" style={{marginTop: '15px'}}/>
